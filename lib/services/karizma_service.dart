...
class KarizmaService {
  ...
  // Seviyeye göre gradient renkleri
  static List<Color> getLevelColors(int karizma) {
    if (karizma >= 5000) {
      return [const Color(0xFFFFD700), const Color(0xFFFF8C00), const Color(0xFFFFD700)];
    }
    if (karizma >= 2500) {
      return [const Color(0xFFFF4500), const Color(0xFFFF8C00)];
    }
    if (karizma >= 1000) {
      return [const Color(0xFF00BFFF), const Color(0xFF9B30FF)];
    }
    if (karizma >= 500) {
      return [const Color(0xFF1E88E5), const Color(0xFF4CAF50)];
    }
    return [const Color(0xFF1E88E5), const Color(0xFF9B30FF), const Color(0xFFFF8C00)];
  }
}