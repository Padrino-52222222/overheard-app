...
class DmScreen extends StatefulWidget {
  ...
  const DmScreen({super.key, this.showHeader = true}); // ← GÜNCELLE
  ...
  Widget build(BuildContext context) {
    return SizedBox.expand(
      child: Container(
        ...
        child: SafeArea(
          top: widget.showHeader, // ← GÜNCELLE (hub içindeyken top padding olmasın)
          child: Column(
            children: [
              ...
              // ── DM Listesi (mevcut Expanded StreamBuilder aynen kalır) ──
