      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Mesajı Sil (sadece kendi mesajı)
            if (isMyMessage) ...[
            ...
            // 🆕 Mesajı Bildir (karşı tarafın mesajı ise)
            if (!isMyMessage) ...[
              const SizedBox(height: 10),
              _optionTile(
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Mesaj silindi', style: TextStyle(color: Colors.white)),
  ...
  Future<void> _pinMessage(String messageId, String text) async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Mesaj tutturuldu 📌', style: TextStyle(color: Colors.white)),
            backgroundColor: const Color(0xFF72246C),
            behavior: SnackBarBehavior.floating,
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
          ),
          ...
          children: [
                  ...
                  Container(
                    ...
                    child: ClipOval(
                      child: widget.friendPhotoUrl != null && widget.friendPhotoUrl!.isNotEmpty
                          ? Image.network(widget.friendPhotoUrl!, fit: BoxFit.cover, width: 38, height: 38)
                          : Center(
            ...
            StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snap) {
                if (!snap.hasData || snap.data?.exists != true) return const SizedBox.shrink();
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.push_pin_rounded, color: Color(0xFFFFD700), size: 16),
                        ...
                        child: Padding(
                          ...
                          child: Align(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: isMe
                                    ? const LinearGradient(colors: [Color(0xFF72246C), Color(0xFF9B30FF)])
